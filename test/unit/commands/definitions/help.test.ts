...
import {getAvailableCommands} from '../../../../src/commands';
import type {
	CommandContext,
	CommandDefinition,
} from '../../../../src/commands/base';

// Note: We're testing helpCommand with the actual getAvailableCommands
// implementation since ES modules make it difficult to stub. The help command
// will show the actual available commands, which is fine for testing purposes.
const helpCommand: CommandDefinition = getAvailableCommands()[0];
